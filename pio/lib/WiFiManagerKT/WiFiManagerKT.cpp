...
void WiFiManager::handleInfo()
{
  ...
  page += F("</table>");
  page += F("<p/>");
  page += F("<hr><h3>Firmware</h3>");
  page += F("<p>This firmware is a modified version of iSpindel 6.0.0 by S. Lang available at: <a href=\"https://github.com/universam1\">github.com/universam1</a></p>");
  page += FPSTR(HTTP_END);
...
void WiFiManager::handleiSpindel()
{
  ...
  page += Volt;
  page += F(" V</td></tr>");
  page += F("<tr><td>Density:</td><td>");
  page += Gravity;
  page += F(" g/cm<sup>3</sup></td></tr>");
  page += F("</table></h2>");
  page += FPSTR(HTTP_END);
  server->send(200, "text/html", page);
...
void WiFiManager::handleMnt()
{
  ...
  page += F("<hr><h2>Firmware Update</h2><br>Select a .bin file to update the firmware.</a>");
  page += F("</dd></dl><br>");
