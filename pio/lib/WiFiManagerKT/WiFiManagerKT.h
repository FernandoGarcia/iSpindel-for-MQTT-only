...
function sST(){
  $('summer').value = parseInt($('ST').options[$('ST').selectedIndex].value);
}
...
const char HTTP_SUMMER_LIST[] PROGMEM = R"V0G0N(
<select id="ST" onclick="sST()">
